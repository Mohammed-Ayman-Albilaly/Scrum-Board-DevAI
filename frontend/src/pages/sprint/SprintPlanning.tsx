...
const SprintPlanning: React.FC = () => {
  ...
  // Mock Data
  const [activeSprint, setActiveSprint] = React.useState<Sprint | null>({
    id: 's1',
  ...
  const [backlogStories, setBacklogStories] = React.useState<Story[]>([
    { id: '1', title: 'JWT Implementation', storyPoints: 5, status: 'READY' },
    { id: '2', title: 'Project Gallery UI', storyPoints: 3, status: 'READY' },
    { id: '3', title: 'RBAC Middleware', storyPoints: 8, status: 'READY' },
    { id: '4', title: 'Postgres Indexing', storyPoints: 2, status: 'UNREFINED' },
  ]);
        ...
        <div className="fixed inset-0 bg-slate-900/50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-xl shadow-xl w-full max-w-lg overflow-hidden">
            ...
            <div className="p-6 space-y-4">
              <Input label="Sprint Name" placeholder="e.g. Sprint 1: Foundations" />
